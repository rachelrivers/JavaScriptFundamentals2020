...
const { getBooksApi, getData } = require("../../exercises/20-promise/promise");

describe("Promise", () => {
  describe("getBooksApi", () => {
    it("should be a promise that will resolve into the response that is like the instructions", () => {
